...
const Experience = forwardRef((props, ref) => {
  return (
    <div
      ...
      <h2>
        General Assembly Immersive Software Engineering Course - London (Online)
      </h2>
      ...
      <h3>
        ...
        with table service as well as regular Supper Evenings/Events throughout
        the year. The Wholesale Department has a dedicated team of cheesemongers
        based in a warehouse in Highbury, where the affinage operations take
        place in specially designed cheese rooms devoted to maturing & refining
        cheese. Over the years La Fromagerie has become the London "go to" place
        for cheese lovers but also anyone attracted to a wide range of delicious
        homemade foods, as well as French/Italian products sometimes difficult
        (or impossible?!) to get your hands on in the UK.
      </h3>
      <a
      ...
      <h3 id='experience-bottom-text'>
        ...
        of Soho's buzzing nightlife. Music would be loud with 80's Hits, 90's
        Hip Hop or noughties Garage. Award Winning cocktails would complement
        the South American spicy and smoky bold flavors and chef Neil Rankin
        would be the star of the show. 6 years later and it keeps being talked
        about as one of the best restaurants London has to offer.
      </h3>
    </div>
  );
});
